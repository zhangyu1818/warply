...
2. "Agent" — `AddAgentTab`, `LayoutAlt01` icon (if AI enabled, ACP AgentView only)
3. "Terminal" — `AddTerminalTab`, `LayoutAlt01` icon
4. Shells — `AddTabWithShell`, `LayoutAlt01` icon (if `ShellSelector` enabled)
5. Launch configs — `LayoutAlt01` icon, skip "Learn about Launch Configs..."
6. Tab configs — `LayoutAlt01` for non-worktree, `Dataflow02` for worktree configs
7. `MenuItem::Separator`
8. "New worktree" — `CreateNewTabConfig`, `Plus` icon

...
pub type SavedWorkflowEnum = GenericCloudObject<GenericStringObjectId, SavedWorkflowEnumModel>;
pub type SavedWorkflowEnumModel = GenericStringModel<WorkflowEnum, JsonSerializer>;

impl StringModel for WorkflowEnum {
    type CloudObjectType = SavedWorkflowEnum;

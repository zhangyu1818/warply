...
pub fn initialize_settings_for_tests_with_mode(
    ...
    use crate::{
        ...
        settings::{
            ...
            BlockVisibilitySettings, CodeSettings, DebugSettings, FontSettings, GPUSettings,
            InputModeSettings, InputSettings, PaneSettings, ScrollSettings, SelectionSettings,
            ThemeSettings, VimBannerSettings, app_icon::AppIconSettings,
            init_and_register_user_preferences, manager::SettingsManager,
        },
        terminal::{

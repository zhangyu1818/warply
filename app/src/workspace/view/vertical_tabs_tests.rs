...
use super::{
    ...
    detail_target_for_hovered_row, format_summary_primary_labels, group_display_name,
    group_name_highlight_indices, matched_group_ids, merge_group_name_matches,
    ...
    tab_admitted_by_group_name, terminal_kind_badge_label, terminal_primary_line_data,
...
fn summary_pane_kind_icons_distinguish_agent_terminals_from_plain_terminals() {
    assert_eq!(
        select_summary_pane_kind_icons([
            ...
            (EntityId::from_usize(30), SummaryPaneKind::Agent),
        ]),
        Some(SummaryPaneKindIcons::Pair {
            primary: SummaryPaneKind::Terminal,
...
#[test]
fn detail_sidecar_supports_terminal_code_and_local_object_panes() {

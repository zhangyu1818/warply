...
pub(super) struct WorkspaceMouseStates {
    ...
    pub(super) system_editor_button: MouseStateHandle,
    pub(super) system_editor_menu: MouseStateHandle,
    pub(super) system_editor: MouseStateHandle,
    ...
    pub(super) update_button: MouseStateHandle,
}
...
impl WorkspaceState {
    pub fn is_any_non_terminal_view_open(&self, _app: &AppContext) -> bool {

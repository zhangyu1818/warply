...
fn file_diff_to_proto_drops_binary_content() {
    ...
    let proto_diff = super::file_diff_to_proto("/repo", &file_diff, Some("binary blob content"));
...
fn file_diff_to_proto_withholds_oversized_content() {
    ...
    let proto_diff = super::file_diff_to_proto("/repo", &file_diff, Some(&oversized));
...
fn file_diff_to_proto_preserves_content_within_budget() {
    ...
    let proto_diff = super::file_diff_to_proto("/repo", &file_diff, Some("small base content"));
...
fn file_diff_to_proto_preserves_content_at_budget_boundary() {
    ...
    let proto_diff = super::file_diff_to_proto("/repo", &file_diff, Some(&at_budget));

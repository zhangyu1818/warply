...
use crate::{
    ...
    settings::{BlockVisibilitySettings, SettingsFileError, log_setting_result},
...
use ai_page::{AISettingsPageAction, AISettingsPageEvent, AISettingsPageView};
...
impl SettingsView {
    fn local_settings_nav_items() -> Vec<SettingsNavItem> {
        vec![
    ...
    pub fn new(page: Option<SettingsSection>, ctx: &mut ViewContext<Self>) -> Self {
        ...
        let nav_items = Self::local_settings_nav_items();
            ...
            EditorEvent::Edited(_) => {
                ...
                if !current_still_visible {
                    ...
                    if let Some(new_section) = first_visible {
                        self.set_and_refresh_current_page_internal(new_section, false, false, ctx);
                    }
                }
                ctx.notify();
            }
    ...
    fn get_modal_content_for_page(
        &self,
        _page_handle: &SettingsPageViewHandle,
        _app: &AppContext,

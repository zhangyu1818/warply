...
use super::settings_page::{
    AdditionalInfo, Category, CategoryHeader, HEADER_FONT_SIZE, HEADER_PADDING, MatchData,
    ...
    fn render_top_of_page(&self, appearance: &Appearance, _app: &AppContext) -> Box<dyn Element> {
        let warpify_description = vec![
            ...
            FormattedTextFragment::hyperlink(
                "Learn more",
                "https://docs.warply.local/terminal/warpify/subshells",
            ),
        ];
                ...
                column.add_child(render_body_item::<WarpifyPageAction>(
                    ...
                    Some(AdditionalInfo {
                        ...
                        on_click_action: Some(WarpifyPageAction::OpenUrl(
                            "https://docs.warply.local/terminal/warpify/ssh".into(),
                        )),
                        secondary_text: None,

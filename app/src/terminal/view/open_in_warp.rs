...
const LEARN_MORE_MARKDOWN_URL: &str =
    "https://docs.warply.local/terminal/more-features/markdown-viewer";
const LEARN_MORE_CODE_URL: &str = "https://docs.warply.local/code/overview#built-in-code-editor";

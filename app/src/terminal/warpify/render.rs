...
pub const SSH_DOCS_URL: &str = "https://docs.warply.local/terminal/warpify/ssh";
pub const SUBSHELL_DOCS_URL: &str = "https://docs.warply.local/terminal/warpify/subshells";

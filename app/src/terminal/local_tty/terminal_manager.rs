...
impl TerminalManager {
    ...
    fn on_shell_determined(
        ...
        let local_identity = LocalIdentityProvider::as_ref(ctx).get();
        ...
        let shell_starter = shell_starter_source
            .map(|source| get_shell_starter_internal(source, bg_executor, local_identity));
        ...
        let generated_session_id = match &shell_starter {
            ShellStarter::Direct(starter) => starter.session_id(),

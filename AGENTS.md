...
- The ACP client is the sole owner of agent execution, sessions, and provider semantics. Upstream Warp Agent behavior is not a missing feature by default; retain or port it only when its local behavior or UI can be routed through ACP.
